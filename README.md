...
| [Terraform Workspaces Demo](https://github.com/satishpkumar/terraform-workspace-demo.git) | Implemented Terraform Workspaces to isolate Dev, QA, and Production environments using separate state files while sharing the same Terraform codebase. Demonstrated the relationship between tfvars, workspaces, and state management | Terraform, AWS VPC, Terraform Workspaces, State Management, tfvars
